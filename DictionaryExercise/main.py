...
occurences = {letter: msg.lower().count(letter) for letter in msg.lower()}
print(occurences)
...
freq_list = sorted(frequency, reverse=True)

sorted_letters = {}
for i in freq_list:
    sorted_letters[frequency.get(i)] = i

print(sorted_letters)


sorted_letters = sorted(occurences, reverse=True, key= lambda l: occurences.get(l))
frequency = {l:occurences.get(l) for l in sorted_letters}
